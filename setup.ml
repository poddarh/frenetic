...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c220999b2d17e8c0ce48bb22cd419f4) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-package";
            "ppx_deriving,ppx_deriving.eq,ppx_deriving.enum,ppx_deriving.show,ppx_jane";
            "-use-menhir";
            "-cflags";
            "-w,@5+8@11@12-40,-short-paths"
         ];
     test =
       [
          ("all_tests",
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$testtool", ["inline-test-runner"; "frenetic"]))
                   ];
     ...
     package =
       {
          ...
          alpha_features = ["ocamlbuild_more_args"; "source_patterns"];
          beta_features = ["findlib_extra_files"];
          name = "frenetic";
          license_file = None;
          copyrights = [];
          maintainers = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ocamlgraph",
                               Some (OASISVersion.VGreaterEqual "1.8.7"));
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "frenetic";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_findlib_extra_files = ["../ppx.native"];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["PPX_NetKAT"];
                      lib_pack = false;
                      lib_internal_modules = ["PPX_NetKAT_Parser"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "ppx";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ppx"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_standalone.ml"});
               Library
                 ({
                     cs_name = "async";
                     cs_data = PropList.Data.create ();
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Frenetic_Common"; "Frenetic_DynGraph"];
                      lib_findlib_parent = Some "frenetic";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "frenetic.ml"});
               Executable
                 ({
                     cs_name = "openflow";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "TestPolicy.ml"});
               Doc
                 ({
                     cs_name = "frenetic";
                     cs_data = PropList.Data.create ();
                                  ...
                                  Some
                                    (("cppo",
                                       [
                                          ...
                                          "\\\n";
                                          "-o";
                                          "lib/Frenetic_NetKAT_Generated_Parser.mly\ncppo";
                                          "-n";
                                          "\\\n";
                                          "ppx/PPX_NetKAT_Parser.cppo.mly";
                                          "\\\n";
                                          "-o";
                                          "ppx/PPX_NetKAT_Parser.mly\nmenhir";
                                          "--only-tokens";
                                          "ppx/PPX_NetKAT_Parser.mly";
                                          "\\\n";
                                          "--base";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "<\146\221\179E\140\023\177B\247\140\229-\149c\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
